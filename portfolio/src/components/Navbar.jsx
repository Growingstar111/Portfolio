...
const Navbar=()=>{
  const [mobileMenuOpen, setmMobileMenuOpen] = useState(false)
    ...
    <h1 className="font-bold ps-4">Vivek Sharma</h1>
      ...
      {mobileMenuOpen && (
        <div className='md:hidden'>
            <div className='space-y-1 px-2 pb-3 pt-2'>
                <a href="#about" className='block rounded-md px-3 py-2 text-base font-medium text-[#334155] hover:bg-[#f8fafc] hover:text-[#0f172a]'>About</a>
                <a href="#projects" className='block rounded-md px-3 py-2 text-base font-medium text-[#334155] hover:bg-[#f8fafc] hover:text-[#0f172a]'>Project</a>

                <a href="#contact" className='block rounded-md px-3 py-2 text-base font-medium text-[#334155] hover:bg-[#f8fafc] hover:text-[#0f172a]'>Contact</a>
            </div>
        </div>
      )}
    </header>
